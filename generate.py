...
# Base paths
base_dir = r"C:\Users\moham\.gemini\antigravity\scratch\LookaGeniusAcademy"
...
pages = {
    ...
    "dashboard-student.html": {
        "nav": "",
        "script": '<script src="js/pages/dashboard-student.js" defer></script>',
        "content": """<main id="dashboardContent"></main>"""
    },
    "dashboard-parent.html": {
        "nav": "",
        "script": '<script src="js/pages/dashboard-parent.js" defer></script>',
        "content": """<main id="dashboardContent"></main>"""
    },
    "dashboard-teacher.html": {
        "nav": "",
        "script": '<script src="js/pages/dashboard-teacher.js" defer></script>',
        "content": """<main id="dashboardContent"></main>"""
    },
    "dashboard-engineer.html": {
        "nav": "",
        "script": '<script src="js/pages/dashboard-engineer.js" defer></script>',
        "content": """<main id="dashboardContent"></main>"""
    },
    "dashboard-accountant.html": {
        "nav": "",
        "script": '<script src="js/pages/dashboard-accountant.js" defer></script>',
        "content": """<main id="dashboardContent"></main>"""
    }
}
...
for filename, info in pages.items():
    nav_dict = {
        "nav_home": "active" if info["nav"] == "nav_home" else "",
        "nav_courses": "active" if info["nav"] == "nav_courses" else "",
        "nav_scholarships": "active" if info["nav"] == "nav_scholarships" else "",
        "nav_support": "active" if info["nav"] == "nav_support" else "",
        "page_script": info["script"]
    }
    
    final_header = header_html.format(**nav_dict)
    final_html = final_header + info["content"] + footer_html
